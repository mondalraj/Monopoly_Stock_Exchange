                    ...
                    if(company.getCompanyOwner(2) == 0){
                        ...
                        if(response == "yes" || response == "Yes" || response=="YES"){
                           if(player.getPlayerCurrentBal(i) >= 6000){
                            ...
                            player.setPlayerCurrentBal(player.getPlayerCurrentBal(owner) + company.getCompanyServiceRent(2) , owner);
                            func.updateServiceRent(2);

                            } else {
                                // Option dena hai player ko stocks aur company sell karne k liye if uske paas paryapt dhan rashi nhi hai.
                            }
